...
// CB layout:
	...
	CB_WindowColor='#888',				// color of the CB window (note: you have to change the rounded-corner PNGs too!), transparent is also working
	...
	CB_ImgBorderColor='#222',			// border color around the picture in CB window
